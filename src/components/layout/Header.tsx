...
export const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed top-16 left-0 w-full z-40 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border-b border-zinc-200 dark:border-zinc-800 shadow-lg">
